							...
							<!-- Starting Content -->
										...
										<div class="col-md-10 col-sm-9 col-xs-9">
											<div class="row">
												<div class="col-md-6 pull-left my-item-titles">
													<a href="<?php echo get_permalink($javo_this_parent_id);?>#item-reviews">
														<h3><?php the_title();
														if(get_post_status()=='pending') _e('(pending)','javo_fr'); ?>
														</h3>
														<span> <?php echo get_the_date(); ?></span>
														<span> <?php echo '/ '. get_the_title($javo_this_parent_id); ?></span>
													</a>
												</div> <!-- col-md-6 -->
												<div class="col-md-6 pull-right">
													<div class="row content-panel-button-list" align="right">
														<a href="<?php echo home_url(JAVO_DEF_LANG.JAVO_MEMBER_SLUG.'/'.wp_get_current_user()->user_login.'/'.JAVO_ADDREVIEW_SLUG.'/edit/'.get_the_ID());?>" type="button" class="btn btn-warning btn-circle mypage-tooltips" title="<?php _e('Edit Item', 'javo_fr'); ?>"><i class="glyphicon glyphicon-pencil"></i></a>
								...
								<div class="javo_pagination">
									...
									echo paginate_links( array(
										...
										, 'total'		=> $javo_this_reviews->max_num_pages
									) );
									?>
								</div><!-- javo_pagination -->
