...
if($iconoutput2==''){
	...
	$btn2_icon_align='right';
		...
		$subop='';
		$subop .='
			<div class="ivan-dual-button to-center  '.$extraclass.'" >

			<div class="dual_buttons '.$hoverstyle.' main-dual " '.$mainbtn.'>

			<div class="ivan-button-wrapper btn-inline place-template bt1 ">';
			if($icon_align=='right')
			{
				$subop .='<a href = "'.$url1.'" '.$target.' class="ivan-button   round-square  with-icon icon-after with-text place-template ult_dual1" style=" '.$icon1_lineht2.';margin-right:px;'.$size.';'.$btncolor_style.$button1_bstyle.'; '.$btnmain_style.';">
			...
			<span class="icon-simple icon-right1 btn1span "  style="'.$icnsize1.';'.$emptyicon.' ">'.$iconoutput.'</span
			</span>
			</a>';
			}
			else{

			$subop .='<a href = "'.$url1.'" '.$target.'class="ivan-button   round-square  with-icon icon-before with-text place-template ult_dual1" style="'.$icon1_lineht2.';margin-right:px;'.$size.';'.$btncolor_style.$button1_bstyle.'; '.$btnmain_style.';">
			<span class="ult-dual-btn-1 ' .$btn_hover_style. '" style=""  '.$btn_hover.'>
			<span class="icon-simple icon-left1 btn1span"  style="'.$icnsize1.';'.$emptyicon.' ">'.$iconoutput.'</span>
		...
		$subop .='<span class="middle-text" style="'.$text_style.'">
			...
			<div class="ivan-button-wrapper btn-inline place-template btn2 ">';
			if($btn2_icon_align=='right')
			{
			$subop .='<a href = "'.$url2.'" '.$target1.' class="ivan-button   round-square  with-icon icon-after with-text place-template ult_dual2"  style="'.$icon2_lineht2.';'.$btncolor1_style.$button2_bstyle.';margin-left:px;'.$size.';'.$btnmain_style.'">
			...
			<span class="icon-simple icon-right2 btn1span"  style="'.$icnsize2.';'.$emptyicon1.' ">'.$iconoutput2.'</span>
			</span>
			</a>';
		  }
		  else{

		  	$subop .='<a href = "'.$url2.'" '.$target1.' class="ivan-button   round-square  with-icon icon-before with-text place-template ult_dual2"  style="'.$icon2_lineht2.';'.$btncolor1_style.$button2_bstyle.';margin-left:-0px;'.$size.'; '.$btnmain_style.'">
			<span class="ult-dual-btn-2 ' .$btn_hover_style. '"  '.$btn2_hover.'>

			<span class="icon-simple icon-left2 btn1span"  style="'.$icnsize2.';'.$emptyicon1.' ">'.$iconoutput2.'</span>
				...
				vc_map(
					array(
					   ...
					   "category" => __("Ultimate VC Addons","smile"),
					    "description" => __("Add a dual button and give some custom style.","smile"),
					   "params" => array(							
					   	...
					   	/*-----------general------------*/
							array(
								"type" => "dropdown",
								"class" => "",
								"heading" => __("Button Hover Style", "smile"),
								...
								"description" => __("Select the Hover style for Button.","smile"),
							...
							array(
								...
								"description" => __("Select the border style for Button.","smile"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Button Border Color", "smile"),
								"param_name" => "btn_color_border",
								"value" => "#333333",
								"description" => __("Select border color for button.", "smile"),	
							...
							/*array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Button Border HoverColor", "smile"),
								"param_name" => "btn_color_hoverborder",
								"value" => "#333333",
								"description" => __("Select border hover color for button.", "smile"),	
								"dependency" => Array("element" => "btn_border_style", "not_empty" => true,
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Button Border Width", "smile"),
					   	...
					   	/*---bt1----*/
					   		array(
									...
									"text" => __("Button Text", "smile"),
									"value" => "",
									"class" => "",
									"group" => __("Button1","smile"),
					   		...
					   		array(
								...
								"value" => "",
								"description" => __("Enter your text here.", "smile"),
								"group" => "Button1",
							),
					   		array(
									"type" => "ult_param_heading",
									"param_name" => "btn1_icon_setting",
									"text" => __("Icon/Image Settings", "smile"),
									"value" => "",
									"class" => "",
									"group" => __("Button1","smile"),
							...
							array(
								...
								"value" => "#333333",
								"description" => __("Icon Color!", "smile"),
								"dependency" => Array("element" => "icon_type","value" => array("selector")),						
								"group" => "Button1",
							),
							array(
								...
								"value" => "#333333",
								"description" => __("Icon hover color !", "smile"),
								"dependency" => Array("element" => "icon_type","value" => array("selector"),
													/*"element" => "btn_hover_style", "not_empty" => true*/),						
								"group" => "Button1",
							),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Icon or Image Background Color ", "smile"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Icon or Image Background Hover Color ", "smile"),
								"param_name" => "icon_color_hoverbg",
								"value" => "#ecf0f1",
								"description" => __("Select background hover color for icon.", "smile"),	
								"dependency" => Array("element" => "icon_style", "value" => array("circle","square","advanced")
									),
								"group" => "Button1",
							),
							array(
								"type" => "dropdown",
								"class" => "",
								"heading" => __("Icon or Image Border Style", "smile"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Icon or Image Border Color", "smile"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Icon or Image Border Hover Color", "smile"),
								"param_name" => "icon_color_hoverborder",
								"value" => "#333333",
								"description" => __("Select border hover color for icon.", "smile"),	
								"dependency" => Array("element" => "icon_border_style", "not_empty" => true),
								"group" => "Button1",
							),
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Icon or Image Border Width", "smile"),
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Icon or Image Border Radius", "smile"),
							...
							array(
									...
									"text" => __("Button Background Settings", "smile"),
									"value" => "",
									"class" => "",
									"group" => __("Button1","smile"),
									'edit_field_class' => 'ult-param-heading-wrapper vc_column vc_col-sm-12',
							...
							array(
								...
								"value" => "#ffffff",
								"description" => __("Select Background Color for Button.", "smile"),	
								"group" => "Button1",
							...
							/*array(
								"type" => "text",
								"heading" => __("<h2>Typography</h2>","smilesmile"),
								"param_name" => "btn2_typograpy",
							...
							array(
								...
								"value" => "#333333",
								"description" => __("Select text color for icon.", "smile"),	
								"group" => "Button1",
							...
							array(
								...
								"value" => "#333333",
								"description" => __("Select text hover color for icon.", "smile"),	
								//"dependency" => Array("element" => "btn_hover_style", "not_empty" => true),
								"dependency" => Array("element" => "btn_hover_style", "value" => array("Style 1","Style 2","Style 3")),
								"group" => "Button1",
							...
							array(
								...
								"value" => "",
								"description" => __("Enter your Button2 text here.", "smile"),
								"group" => "Button2",
							),
							array(
									"type" => "ult_param_heading",
									"param_name" => "btn1_icon_setting",
									"text" => __("Icon/Image Settings", "ultimate"),
									"value" => "",
									"class" => "",
									"group" => __("Button2","smile"),
									'edit_field_class' => 'ult-param-heading-wrapper vc_column vc_col-sm-12',
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Icon HoverColor", "smile"),
							...
							array(
								"type" => "number",
								"class" => "",
								"heading" => __("Icon or Image Background Size", "smile"),
...
/**/
							...
							array(
								"type" => "dropdown",
								"class" => "",
								"heading" => __("Select Deivider options", "smile"),
							...
							array(
								...
								"value" => "or",
								"description" => __("Enter your Divider text here.", "smile"),
							...
							array(
								"type" => "colorpicker",
								"class" => "",
								"heading" => __("Text/Icon Color", "smile"),
								"param_name" => "divider_text_color",
								"value" => "#ffffff",
								"description" => __("Select  color for divider text/icon.", "smile"),	
							...
							array(
								...
								"value" => "#333333",
								"description" => __("Select border color for Icon/Text/Image.", "smile"),	
